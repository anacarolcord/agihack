...
public class ManutencaoService {
    ...
    public List<Manutencao> buscarPorFuncionarioAtivo(Long funcionarioId) {
        return filtrarCanceladas(manutencaoRepository.findByFuncionarioIdFuncionario(funcionarioId));
    }
    ...
    public List<Manutencao> buscarPorFuncionarioEStatusAtivo(Long funcionarioId, StatusManutencao status) {
        return filtrarCanceladas(manutencaoRepository.findByFuncionarioIdFuncionarioAndStatusManutencao(funcionarioId, status));
    }

    public List<Manutencao> buscarPorEquipamento(Long equipamentoId) {
        return filtrarCanceladas(manutencaoRepository.findByEquipamentoIdEquipamento(equipamentoId));
    }
    ...
    public List<Manutencao> buscarPorEquipamentoEDataPrevista(Long equipamentoId, LocalDate dataPrevista) {
        return filtrarCanceladas(manutencaoRepository.findByEquipamentoIdEquipamentoAndDataPrevista(equipamentoId, dataPrevista));
    }

    public List<Manutencao> buscarPorEquipamentoEDataEntrega(Long equipamentoId, LocalDate dataEntrega) {
        return filtrarCanceladas(manutencaoRepository.findByEquipamentoIdEquipamentoAndDataEntrega(equipamentoId, dataEntrega));
    }
